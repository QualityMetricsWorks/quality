const ES_EN={
  ...
  "Metrics Works valida la información antes de crear o finalizar la corrida.": "Metrics Works validates the information before creating or completing the run.",
  "Opcional": "Optional",
  ...
  "Define los turnos y el tiempo planificado que Metrics Works utilizará para calcular OEE.": "Define the shifts and planned time Metrics Works will use to calculate OEE.",
  "Turnos": "Shifts",
  "Inicio": "Start",
  "Fin": "End",
  ...
  "Regla OEE": "OEE Rule",
  "Cómo calcula Metrics Works": "How Metrics Works Calculates",
  ...
  "Metrics Works cuenta una sola vez el tiempo planificado por combinación": "Metrics Works counts planned time once per combination",
  ...
  "Registro de quién hizo qué, cuándo y sobre qué información dentro de Metrics Works.":"Record of who did what, when, and on which information in Metrics Works.",
  ...
  "Accesos": "Access",
  "crea o invita al usuario en Supabase Authentication y después asígnalo aquí. Metrics Works nunca expone una service key.": "create or invite the user in Supabase Authentication and then assign them here. Metrics Works never exposes a service key.",
